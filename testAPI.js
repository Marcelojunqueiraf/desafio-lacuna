...
(async () => {
    ...
    await axios.post(`${BASE_URL}/receitas`, {
        ...
        descricao: 'Uma receita simples de arroz com feijão',
    });
    await axios.post(`${BASE_URL}/receitas`, {
        nome: 'Carne Assada',
        descricao: 'Uma receita deliciosa de carne assada',
    });
    await axios.post(`${BASE_URL}/receitas`, {
        nome: 'Salada',
        descricao: 'Uma receita refrescante de salada',
    });
    ...
    console.log(receita.data); // {id: 1, nome: 'Arroz com Feijão', descricao: 'Uma receita simples de arroz com feijão'}

    // atualiza receita 2
    console.log('Atualizando receita 2');
    await axios.patch(`${BASE_URL}/receitas/2`, {
        nome: 'Carne Assada com Batatas',
        descricao: 'Uma receita deliciosa de carne assada com batatas',
    });
    ...
    console.log(receitaComIngredientes.data); // {id: 1, nome: 'Arroz com Feijão', descricao: 'Uma receita simples de arroz com feijão', ingredientes: [{...}, {...}]}
    ...
    console.log(receitaAtualizada.data); // {id: 1, nome: 'Arroz com Feijão', descricao: 'Uma receita simples de arroz com feijão', ingredientes: [{...}]}
})().catch((error) => {
